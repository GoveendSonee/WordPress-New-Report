...
<p>Welcome to the exciting world of Mithila Code Creation. Built in Object Oriented Programming paradigm with high number of custom fields and tons of options. Allows you to bring custom admin, metabox, taxonomy and customize settings to all of your pages, posts and categories. It's highly modern and advanced framework.</p>
...
<div class="csf-welcome-cols">
  ...
  <div class="csf--col-upgrade">
    <a href="http://mithilacodecreation.com/" class="button button-primary" target="_blank" rel="nofollow"><i class="fas fa-share"></i> Upgrade Premium Version</a>
  </div>
  <?php } ?>
