...
if ( ! class_exists( 'CSF_Welcome' ) ) {
  class CSF_Welcome{
    ...
    public function __construct() {
      ...
      if ( CSF::$premium && ( ! CSF::is_active_plugin( 'mithilacodecreation-framework/mithilacodecreation-framework.php' ) || apply_filters( 'csf_welcome_page', true ) === false ) ) { return; }
    ...
    public function add_about_menu() {
      add_management_page( 'Mithila Code Creation', 'Mithila Code Creation', 'manage_options', 'csf-welcome', array( $this, 'add_page_welcome' ) );
    }
    ...
    public static function add_plugin_action_links( $links, $plugin_file ) {
      ...
      if ( $plugin_file === 'mithilacodecreation-framework/mithilacodecreation-framework.php' && ! empty( $links ) ) {
        $links['csf--welcome'] = '<a href="'. esc_url( admin_url( 'tools.php?page=csf-welcome' ) ) .'">Settings</a>';
        if ( ! CSF::$premium ) {
          $links['csf--upgrade'] = '<a href="http://mithilacodecreation.com/">Upgrade</a>';
        }
      }
    ...
    public static function add_plugin_row_meta( $links, $plugin_file ) {
      ...
      if ( $plugin_file === 'mithilacodecreation-framework/mithilacodecreation-framework.php' && ! empty( $links ) ) {
        $links['csf--docs'] = '<a href="http://mithilacodecreation.com/documentation/" target="_blank">Documentation</a>';
      }
